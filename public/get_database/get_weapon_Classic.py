...
# 開啟目標網頁
driver.get('https://tracker.gg/valorant/db/weapons/Classic')
...
with open('database/weapon_skin_Classic.json', 'w', encoding='utf-8') as f:
    json.dump(weapon_data, f, ensure_ascii=False, indent=4)

print("武器名稱已保存至 database/weapon_skin_Classic.json")
